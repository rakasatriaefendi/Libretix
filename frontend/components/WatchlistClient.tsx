  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-lg border border-white/10 bg-black/40 p-3">
      <Link href={`/stock/${encodeURIComponent(stock.ticker)}`} className="min-w-0 flex-1">
        <div className="truncate text-sm font-semibold text-white/90">{stock.ticker}</div>
        <div className="truncate text-xs text-white/55">{stock.name ?? toMarketLabel(stock.market)}</div>
        <div className="text-[11px] text-white/35">{toMarketLabel(stock.market)}</div>
      </Link>
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-2 text-sm text-white/45">Cari ticker, lalu tambahkan saham atau crypto yang ingin Anda pantau.</p>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="text-xs text-white/40">{searchResults.length} results</span>
          </div>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="text-xs text-white/40">{tickers.length} saved</span>
          </div>
        </CardHeader>
        <CardContent>
